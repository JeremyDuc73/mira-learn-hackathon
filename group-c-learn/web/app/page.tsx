...
const FEATURED_CLASSES = [
  {
    slug: "pitch-intensif-demo",
    title: "Pitch Investor Masterclass",
    mentorName: "Samuel Martin",
    format: "live hybride",
    durationWeeks: 6,
  ...
  {
    slug: "ux-design-saas",
    title: "UX Design pour SaaS",
    mentorName: "Laure Dupont",
    format: "live virtuel",
    durationWeeks: 8,
  ...
  {
    slug: "growth-b2b-100k-mrr",
    title: "Growth B2B — 0 à 100k MRR",
    mentorName: "Thomas Rémy",
    format: "live hybride",
    durationWeeks: 5,
    skills: ["Growth Hacking", "Copywriting"],
    priceEur: 84,
